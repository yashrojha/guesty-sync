<?php
    ...
    function guesty_sync_settings_page() {
        ...
        <div class="wrap">
            ...
            <h2 class="nav-tab-wrapper">
                ...
                <a href="?page=guesty-sync-settings&tab=booking_settings" 
                class="nav-tab <?php echo $active_tab == 'booking_settings' ? 'nav-tab-active' : ''; ?>">
                <span class="dashicons dashicons-cart"></span> Booking Settings
                </a>
            </h2>
            <div class="guesty-tab-content" style="padding: 20px; background: #fff; border: 1px solid #ccc; border-top: none;">
                ...
                } elseif ($active_tab == 'booking_settings') {
                    guesty_render_booking_settings();
                } else {
    ...
    function guesty_render_booking_settings() {
        ...
        <form method="post" action="options.php">
            ...
            do_settings_sections('guesty_booking_settings_group');
            ?>
            ...
            <div style="background:#f0f6fc;border-left:4px solid #2271b1;padding:12px 16px;margin-top:20px;">
                <strong>How to use the Instant Booking page:</strong><br>
                The booking page is available at <code><?php echo esc_url(home_url('/instant-booking/')); ?></code>.<br>
                It accepts URL parameters: <code>check_in</code>, <code>check_out</code>, <code>guest</code>, <code>listing_id</code>.<br>
                If you changed the URL structure, go to <strong>Settings &rsaquo; Permalinks</strong> and click Save to flush rewrite rules.
            </div>
            <?php submit_button(); ?>
        </form>
        <?php
    ...
    function guesty_render_open_api_settings() {
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                ...
                <tr>
                    <th scope="row">Current Access Token</th>
                    <td>
                        <input type="text"
                            class="regular-text"
                            ...
                            placeholder="Token will appear here after a successful connection" />
                        <p class="description">
                            This is the cached <code>guesty_access_token</code> used for API calls.
                            It is read-only and refreshed automatically; click in the field to copy it for testing.
                        </p>
                    </td>
                </tr>
            </table>
