...
if (!$page_error) {
    $q_response = wp_remote_post('https://open-api.guesty.com/v1/quotes', [
        ...
        if (is_wp_error($q_response)) {
            ...
            if (in_array($debug_http_code, [200, 201], true)
                && is_array($quote_data)
                ...
                $page_error = $api_msg ?: 'These dates are not available for this property. Please go back and choose different dates.';
            }
        }
}
    ...
    <div class="booking-page-inner">
        ...
        <div class="gbk-error-screen">
            ...
            <div class="gbk-error-actions">
                <a href="<?php echo esc_url($property_url); ?>" class="gbk-btn gbk-btn-secondary" style="display:inline-block;width:auto;padding:16px 36px;">
                    ← Change Dates
                </a>
                <a href="<?php echo esc_url(get_post_type_archive_link('properties')); ?>" class="gbk-btn gbk-btn-outline" style="display:inline-block;width:auto;padding:16px 36px;">
            ...
            <div class="booking-steps-column">
                ...
                <div class="booking-step" id="gbk-step-1">
                    <div class="step-header">
                        <span class="step-number active" id="gbk-num-1">1</span>
                        ...
                        <form id="gbk-guest-form" novalidate>
                            <div class="gbk-form-grid">
                                <div class="gbk-field">
                                    ...
                                    <input type="text" id="gbk_first_name" name="firstName" placeholder="Enter your name" autocomplete="given-name" required>
                                </div>
                                <div class="gbk-field">
                                    <label for="gbk_last_name">Last name</label>
                                    <input type="text" id="gbk_last_name" name="lastName" placeholder="Enter your last name" autocomplete="family-name" required>
                                </div>
                                <div class="gbk-field">
                                    <label for="gbk_phone">Phone</label>
                                    <input type="tel" id="gbk_phone" name="phone" placeholder="Enter your phone" autocomplete="tel">
                                </div>
                                <div class="gbk-field">
                                    <label for="gbk_email">Email</label>
                                    <input type="email" id="gbk_email" name="email" placeholder="Enter your email" autocomplete="email" required>
                                </div>
                            </div>
                            <div class="gbk-terms">
                ...
                <div class="booking-step locked" id="gbk-step-2">
                    <div class="step-header">
                        <span class="step-number" id="gbk-num-2">2</span>
                ...
                <div class="booking-step locked" id="gbk-step-3">
                    <div class="step-header">
                        <span class="step-number" id="gbk-num-3">3</span>
...
(function () {
    ...
    function activateStep(step) {
        ...
        if (prevEl && step !== currentStep) {
            ...
            if (num) { num.textContent = '✓'; num.classList.remove('active'); num.classList.add('done'); }
    ...
    document.getElementById('gbk-guest-form').addEventListener('submit', async function (e) {
        ...
        const email     = document.getElementById('gbk_email').value.trim();
        const phone     = document.getElementById('gbk_phone').value.trim();
        const termsOk   = document.getElementById('gbk_terms_agree').checked;

        if (!firstName || !lastName) { showError('gbk-error-1', 'Please enter your first and last name.'); return; }
        if (!email)                   { showError('gbk-error-1', 'Please enter your email address.');        return; }
        if (!termsOk)                 { showError('gbk-error-1', 'Please agree to the Terms & Conditions and Privacy Policy.'); return; }
        ...
        try {
            ...
            const res  = await fetch(GBK.ajaxUrl, { method: 'POST', body: fd });
    ...
    if (edit1) {
        edit1.addEventListener('click', function () {
            ...
            ['gbk-step-2','gbk-step-3'].forEach(function(id) {
                ...
                if (num) { num.textContent = id.slice(-1); num.classList.remove('done','active'); }
            });
        });
    }
